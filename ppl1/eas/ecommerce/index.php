            ...
            <div class="row property__gallery">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix women">
                    <div class="product__item">
                        ...
                        <div class="product__item__pic set-bg" data-setbg="img/product/<?php echo $row['foto'];?>">
                        ...
                        <div class="product__item__text">
                            <h6><a href="#"><?php echo $row['nama_barang'];?></a></h6>
                            <div class="rating">
                            ...
                            <div class="product__price">Rp<?php echo $row['harga_barang'];?></div>
                            <a class="btn btn-primary" href="add-cart.php?id_barang=<?php echo $row['id_barang'];?>">add to chart</a>
                        </div>
                    </div>
                </div>
                <?php
