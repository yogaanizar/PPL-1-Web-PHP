                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form action="tables.php" method="post"
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Data Mahasiswa"
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped border-secondary" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Foto</th>
                                            <th>NIP</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td><img src="namafilefoto/<?php echo $row["namafilefoto"]?>" width="100px" height="100px"></td>
